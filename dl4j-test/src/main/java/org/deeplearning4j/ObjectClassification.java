package org.deeplearning4j.solutions.convolution;
 ...
 *
 * Search for the part with *REPLACE NULL WITH MODEL CONFIGURATION* comment and replace with model configuration
 */
public class ObjectClassification
{
    ...
    public void run() throws Exception
    {
        ...
        /**
         * REPLACE NULL WITH MODEL CONFIGURATION
         */

        MultiLayerConfiguration config = null; //here
